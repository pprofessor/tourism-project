...
const UserManagement: React.FC = () => {
  ...
  const handleUpdateUser = useCallback(async () => {
    ...
    try {
      ...
      // 🔍 دیباگ کامل
      console.log(
        "emailVerified value before sending:",
        editingUser.emailVerified,
        "Type:",
        typeof editingUser.emailVerified
      );
  ...
  return (
    <Box sx={{ p: 3 }}>
              ...
              <Box sx={{ display: "grid", gap: 2 }}>
                ...
                <Box>
                  ...
                  <Typography variant="body1">
                    {selectedUser.phone || selectedUser.mobile || "ثبت نشده"}
                  </Typography>
                </Box>
      ...
      >
        ...
        <DialogContent>
          <Typography>
            آیا از حذف کاربر <strong>{deleteConfirmUser?.username}</strong> (
            {deleteConfirmUser?.email}) مطمئن هستید؟
          </Typography>
        ...
        <DialogActions>
          <Button onClick={() => setDeleteConfirmUser(null)}>انصراف</Button>
          <Button
